...
def main():
    ...
    print(f"Welcome to the {crayons.green('Network')} Device Command Pusher") # welcome message with green text
    ...
    print("Successfully found the ip, It will return {crayons.yellow('NOTHING')")
